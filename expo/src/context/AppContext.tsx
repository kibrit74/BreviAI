...
const translations = {
    tr: {
        ...
        voiceCmdSummarizeNotes: 'notlarımı özetle',
        voiceCmdSummarizeEmails: 'maillerimi özetle',
        voiceCmdReadCalendar: 'takvimimi oku',
        voiceCmdListEvents: 'etkinlikleri listele',
        voiceCmdPlanDay: 'günümü planla',
        voiceCmdCreateReminder: 'yarın için hatırlatıcı oluştur',
        voiceCmdSendDailyReport: 'günlük raporu gönder',
        voiceCmdCheckWeather: 'hava durumunu kontrol et',
        voiceCmdShowTodayTasks: 'bugünkü görevlerimi göster',
        // About Screen
    ...
    en: {
        ...
        voiceCmdSummarizeNotes: 'summarize my notes',
        voiceCmdSummarizeEmails: 'summarize my emails',
        voiceCmdReadCalendar: 'read my calendar',
        voiceCmdListEvents: 'list upcoming events',
        voiceCmdPlanDay: 'plan my day',
        voiceCmdCreateReminder: 'create a reminder for tomorrow',
        voiceCmdSendDailyReport: 'send the daily report',
        voiceCmdCheckWeather: 'check the weather',
        voiceCmdShowTodayTasks: 'show my tasks for today',
        // About Screen
